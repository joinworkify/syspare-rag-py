    ...
    def _build_multimodal_prompt(
        ...
        *,
        ...
        return (
            ...
            "2. Safety first. If a step could create a safety hazard, warn the user clearly BEFORE the steps; avoid giving dangerous or high-risk repair instructions and instead advise a qualified technician for those.\n"
            ...
            f"5. If the context does not contain enough actionable information to genuinely help (and the question IS about the selected manual's machine), begin your reply with the token {INSUFFICIENT_CONTEXT_SENTINEL} on its own first line, then give only safe general precautions and recommend contacting a local Yanmar dealer. Do NOT use this token for questions about other machine models (handle those per instruction 3).\n"
            "6. CRITICAL CITATION RULE: When answering, if you use or reference information from a specific image to support your explanation, "

...
class MultimodalRAGPipeline:
    ...
    def build_metadata(
        ...
        *,
        ...
        text_df, image_df = utils.get_document_metadata(
    ...
    def search_text(
        ...
        *,
        ...
        return utils.get_similar_text_from_query(
            query,
    ...
    def search_images_by_description_text(
        ...
        *,
        ...
        if not self.has_metadata:
            raise RuntimeError("Run build_metadata() first.")
        embedding_size = embedding_size or self.config.embedding_size
        return utils.get_similar_image_from_query(
            self.text_metadata_df,  # type: ignore
    ...
    def answer_text_query(
        ...
        *,
        ...
        response = utils.get_gemini_response(
            self.text_model,
    ...
    def print_text_citations(
        ...
        *,
        ...
        utils.print_text_to_text_citation(
            matches, print_top=print_top, chunk_text=chunk_text
        )
    ...
    def print_image_citations(
        ...
        *,
        ...
        utils.print_text_to_image_citation(matches, print_top=print_top)

    def show_images(self, img_paths: List[str], *, resize_ratio: float = 0.5) -> None:
        utils.display_images(img_paths, resize_ratio=resize_ratio)
